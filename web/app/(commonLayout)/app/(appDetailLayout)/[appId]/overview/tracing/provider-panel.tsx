...
import { LangfuseIconBig, LangsmithIconBig, OpikIconBig, ArizePhoenixIconBig } from '@/app/components/base/icons/src/public/tracing'
...
const getIcon = (type: TracingProvider) => {
  return ({
    ...
    [TracingProvider.arizePhoenix]: ArizePhoenixIconBig,
  })[type]
}
